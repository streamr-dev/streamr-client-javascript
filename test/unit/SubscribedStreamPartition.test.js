...
describe('SubscribedStreamPartition', () => {
    ...
    describe('subscriptions', () => {
        ...
        it('should call setGroupKeys() and checkQueue() for every subscription', async () => {
            ...
            expect(sub2.setGroupKeys.calledWith('publisherId', ['group-key-1', 'group-key-2'])).toBeTruthy()
            expect(sub3.setGroupKeys.calledWith('publisherId', ['group-key-1', 'group-key-2'])).toBeTruthy()
        })
    })
})
